...
object NetworkGraph {
    ...
    fun getBaseSimulation(strength: Int, collisionFactor: Float, zoomType: Boolean): String {
        return "var simulation = d3.forceSimulation()\n" +
                ...
                "\n" +
                "var zoomTypeResponsive = $zoomType\n" +
