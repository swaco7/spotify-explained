...
object RadarChart {
    ...
    fun getChartDesignHeader(width: Int, selected: Int): String {
        return  "/* Radar chart design created by Nadieh Bremer - VisualCinnamon.com */\n" +
                ...
                "  .range([\"#177ADF\", \"#2CBA3D\", \"#2CB9BA\", \"#2C49BA\", \"#752DB4\", \"#CC333F\", \"#FFDB58\", \"#FFA500\"]);\n" +
                "\n" +
