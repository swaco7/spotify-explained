...
/**
 * Fragment dedicated to recommendations from custom recommender system based on similarity with all user's tracks
 */
@SuppressLint("SetJavaScriptEnabled")
class CustomRecommendOverallFragment : Fragment(), TrackDetailClickHandler, GraphClickHandler{
    private lateinit var viewModel: CustomRecommendOverallViewModel
    private lateinit var adapter: TracksRecommendedBaseDatabaseAdapter<TrackEntity>
    private var _binding: FragmentRecommendCustomOverallBinding? = null
    ...
    private val showLineDetailInfoFunc = { message: String -> this.showLineDetailInfo() }
    ...
    override fun onCreateView(
        ...
        )[CustomRecommendOverallViewModel::class.java]
        _binding = FragmentRecommendCustomOverallBinding.inflate(inflater, container, false)
