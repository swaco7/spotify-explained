...
class TopTracksFragment : Fragment(), TrackDetailClickHandler, GraphClickHandler {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        viewModel.tracks.observe(viewLifecycleOwner, adapter::updateData)
