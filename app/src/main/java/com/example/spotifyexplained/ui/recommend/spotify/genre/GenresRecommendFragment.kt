...
/**
    This fragment is dedicated to recommendations from Spotify based on genre seeds
 */
@SuppressLint("SetJavaScriptEnabled")
class GenresRecommendFragment : Fragment(), TrackDetailClickHandler, GraphClickHandler {
    private lateinit var viewModel: GenresRecommendViewModel
    private lateinit var adapter: TracksRecommendedBaseDatabaseAdapter<GenreRecommendEntity>
    private var _binding: FragmentRecommendGenresBinding? = null
    ...
    private val showBundleDetailInfoFunc =
        { tracks: String, message: String -> this.showBundleDetailInfo(tracks, message) }
    ...
    override fun onCreateView(
        ...
        )[GenresRecommendViewModel::class.java]
        _binding = FragmentRecommendGenresBinding.inflate(inflater, container, false)
